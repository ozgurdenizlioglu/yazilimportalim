...
<div class="card shadow-sm">
    <div class="card-body">
        <form method="POST" action="/muhasebe/store" class="row g-3">

            <div class="col-md-6">
                <label for="proje" class="form-label">Proje</label>
                <input type="text" class="form-control" id="proje" name="proje" required>
            </div>

            <div class="col-md-6">
                <label for="tahakkuk_tarihi" class="form-label">Tahakkuk Tarihi</label>
                <input type="date" class="form-control" id="tahakkuk_tarihi" name="tahakkuk_tarihi">
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="cek_no" name="cek_no">
            </div>
            ...
            <div class="col-12">
                ...
                <textarea class="form-control" id="aciklama2" name="aciklama2" rows="2"></textarea>
            </div>

            <div class="col-12">
                <label for="aciklama3" class="form-label">Açıklama 3</label>
                <textarea class="form-control" id="aciklama3" name="aciklama3" rows="2"></textarea>
            </div>

            <div class="col-md-6">
                <label for="tutar_try" class="form-label">Tutar (TRY)</label>
                <input type="number" class="form-control" id="tutar_try" name="tutar_try" step="0.01">
            </div>

            <div class="col-md-6">
                <label for="usd_karsiligi" class="form-label">USD Karşılığı</label>
                <input type="number" class="form-control" id="usd_karsiligi" name="usd_karsiligi" step="0.01">
            </div>

            <div class="col-md-6">
                <label for="cari_hesap_ismi" class="form-label">Cari Hesap İsmi</label>
                <input type="text" class="form-control" id="cari_hesap_ismi" name="cari_hesap_ismi">
            </div>

            <div class="col-md-6">
                <label for="wb" class="form-label">WB</label>
                <input type="text" class="form-control" id="wb" name="wb">
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="row_col" name="row_col">
            </div>
            ...
            <div class="col-12">
                ...
                <textarea class="form-control" id="dikkate_alinmayacaklar" name="dikkate_alinmayacaklar" rows="2"></textarea>
            </div>

            <div class="col-md-6">
                <label for="id_text" class="form-label">ID (Text)</label>
                <input type="text" class="form-control" id="id_text" name="id_text">
            </div>

            <div class="col-md-6">
                <label for="id_veriler" class="form-label">ID Veriler</label>
                <input type="text" class="form-control" id="id_veriler" name="id_veriler">
            </div>

            <div class="col-12">
                <label for="id_odeme_plan_satinalma_odeme_onay_listesi" class="form-label">ID - Ödeme Plan & Satın Alma Ödeme Onay Listesi</label>
                <input type="text" class="form-control" id="id_odeme_plan_satinalma_odeme_onay_listesi" name="id_odeme_plan_satinalma_odeme_onay_listesi">
            </div>

            <div class="col-12">
                <label for="not_field" class="form-label">Not</label>
                <textarea class="form-control" id="not_field" name="not_field" rows="2"></textarea>
            </div>

            <div class="col-12">
                <label for="not_ool_odeme_plani" class="form-label">Not OOL/Ödeme Planı</label>
                <textarea class="form-control" id="not_ool_odeme_plani" name="not_ool_odeme_plani" rows="2"></textarea>
            </div>

          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-12">
                ...
                $statusOpts = ['active', 'prospect', 'lead', 'suspended', 'inactive']; ?>
              ...
              <div class="col-12">
                <div class="d-flex flex-column gap-2 pt-1">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="contractor" name="contractor" value="1" <?= $checked($c['contractor'] ?? false) ? 'checked' : '' ?>>
                    <label class="form-check-label" for="contractor">Müteahhit/Yapıcı Firma (contractor)</label>
                  </div>
                  <div class="form-check">
              ...
              <div class="col-12">
                ...
                <?php if (!empty($c['logo_url'])): ?>
                  <div class="mb-2">
                    <img src="<?= Helpers::e($c['logo_url']) ?>" alt="Current Logo" style="max-height: 100px; max-width: 200px;" class="img-thumbnail">
                    <p class="text-muted small mt-1">Mevcut logo</p>
                  </div>
                <?php endif; ?>
                <input type="file" name="logo_file" accept="image/*" class="form-control">
                <small class="form-text text-muted">PNG, JPG, JPEG, GIF dosyaları kabul edilir. Maksimum 2MB.</small>
                <input type="hidden" name="existing_logo_url" value="<?= Helpers::e($c['logo_url'] ?? '') ?>">
              </div>
              <div class="col-12">

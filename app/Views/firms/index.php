...
#firmsTable thead { vertical-align: bottom; }
...
#firmsTable th.col-actions { padding-left: .25rem; padding-right: .25rem; }
...
#firmsTable td .btn-group { gap: 4px; }

#firmsTable td .btn-group .btn { border-width: 1px; }

#firmsTable thead th.sortable { cursor: pointer; }

#firmsTable thead th.sortable[data-sort="asc"]::after { content: " ↑"; opacity: .6; }

#firmsTable thead th.sortable[data-sort="desc"]::after { content: " ↓"; opacity: .6; }
...
/* Uzun linklerin kırpılması için (website) */

.truncate { max-width: 240px; display: inline-block; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; vertical-align: bottom; }
